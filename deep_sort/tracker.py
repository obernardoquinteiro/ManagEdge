...
class Tracker:
    ...
    def __init__(self, metric, max_iou_distance=0.7, max_age=30, n_init=3):
        ...
        self.kf: kalman_filter.KalmanFilter = kalman_filter.KalmanFilter()
        self.tracks = []
        self._next_id = 1
    ...
    def update(self, detections: List[Detection], time: Union[int, datetime.datetime]):
    ...
    def _initiate_track(self, detection: Detection, time):
